...
Now open putty on your laptop and enter the IP adress of the raspberry pi, you can find the IP adress of the raspberry pi with Angry IP Scanner https://angryip.org/
